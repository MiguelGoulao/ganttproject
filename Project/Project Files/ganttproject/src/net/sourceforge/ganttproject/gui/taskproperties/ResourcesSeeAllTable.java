 ...
 */
public class ResourcesSeeAllTable {
    private static GanttLanguage language = GanttLanguage.getInstance();
    private static final String[] COLUMN_NAMES = new String[] { "Name","Role" };
    ...
    private net.sourceforge.ganttproject.resource.HumanResourceManager humanResource;

    public ResourcesSeeAllTable(CustomPropertyManager manager, UIFacade uifacade,
